...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" href="asset('images/dashboardimages/favicon.ico')" type="image/x-icon">
    <!-- vendor css -->
			...
			<div class="navbar-content scroll-div " >
				...
				<div class="">
					<div class="main-menu-header">
						<img class="img-radius" src="asset('images/dashboardimages/avatar-2.jpg')" alt="User-Profile-Image">
								...
								<div class="dropdown-menu dropdown-menu-right notification">
									...
									<ul class="noti-body">
										...
										<li class="notification">
											<div class="media">
												<img class="img-radius" src="asset('images/dashboardimages/user/avatar-1.jpg')" alt="Generic placeholder image">
...
<script src="{{ mix('js/jsfordash/vendor-all.min.js') }}" type="text/javascript"></script>
<script src="{{ mix('js/jsfordash/plugins/bootstrap.min.js') }}" type="text/javascript"></script>
<script src="{{ mix('js/jsfordash/ripple.js') }}" type="text/javascript"></script>
<script src="{{ mix('js/jsfordash/pcoded.min.js') }}" type="text/javascript"></script>
<script src="{{ mix('js/jsfordash/plugins/apexcharts.min.js') }}" type="text/javascript"></script> --}}
</body>
